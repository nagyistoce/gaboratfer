\documentclass[12pt,a4paper]{ReportAA}
...
Metoda $k-nn$ radi na principu promatranja $k$ najbližih susjeda uzorka koji se klasificia.
Primjeri su točke u $n$-dimenzionalnom prostoru $R^{n}$, a za račun udaljenosti koristi se
...
\begin{equation}
f(x_q)=\arg\max_v \sum_{i=1}^k \delta(v,f(x_i))
\end{equation}
