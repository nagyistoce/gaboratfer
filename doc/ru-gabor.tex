...
također može biti izražen polarnim koordinatama kao radialna\TODO{U
...
orijentacija ($\theta$), fazni pomak ($\varphi$), omjer \engl{aspect ratio}
($\gamma $) i širina \engl{bandwidth} ($b$) \citep{petkovgabor}. Promjena
parametara jest stvaranje novog filtera.
...
nul--prijelazima\TODO{``sampled in its zero crossings'' = u svojim nul\ldots?}.
